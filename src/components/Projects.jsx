...

      {
        activeForm === "editProjects" ? (
          <form onSubmit={(e) => handleSubmit(e)}>
            <input type="text" id="name" name="name" className="name" placeholder='Project Name' onChange={(e) => handleChange(e)}/>
            <input type="text" id="technologiesUsed" name="technologiesUsed" className="technologiesUsed" placeholder='Tools/Technologies Used' onChange={(e) => handleChange(e)}/>
            <textarea name="description" rows="4" id="description" className="description" placeholder='Project Description' onChange={(e) => handleChange(e)}></textarea>
